...
- вводим невалидный данные в поле номер карты (буквенные значения, спецсимволы, с дефисом, апострофом)
- кнопка продолжить
...
- нажать кнопку "Купить"
- вводим валидные данные плательщика в поля: номер карты, владелец, CVC,месяц
- вводим невалидные год (буквенные значения, спецсимволы, с дефисом, апострофом)
...
- вводим невалидные данные в поле Владелец - фамилию (кирилица, спецсимволы, эмодзи, цифры)
- кнопка продолжить
...
- нажать кнопку "Купить"
- вводим валидные данные в поля: номер карты, CVC, месяц, год
- вводим невалидные данные в поле Владелец - имя (кирилица, спецсимволы, эмодзи, цифры)
- кнопка продолжить
...
- нажать кнопку "Купить"
- вводим валидные данные в поля: номер карты, CVC, месяц, год
- вводим недопустивое количество символов в поле Владелец - имя  (63,64,65,66 символа)
- кнопка продолжить
...
- нажать кнопку "Купить"
- вводим валидные данные в поля: номер карты, CVC, месяц, год
- вводим недопустивое количество символов в поле Владелец - фамилия (63,64,65,66 символа)
- кнопка продолжить
...
- зайти на страницу покупки
- нажать кнопку "Купить"
- вводим невалидные данные CVC/CVV(кирилица, спецсимволы, эмодзи, цифры)
- кнопка продолжить
